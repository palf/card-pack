...
var Setup = require('./spider/setup'),
    Checks = require('./spider/checks'),
    Actions = require('./spider/actions'),
    Board = require('./spider/board'),
    Input = require('./spider/input');
...
},{"./common/bindings":2,"./common/drag":5,"./common/game":6,"./common/render":8,"./common/shuffle":9,"./common/undo":10,"./spider/actions":12,"./spider/board":13,"./spider/checks":14,"./spider/input":15,"./spider/setup":16}],12:[function(require,module,exports){
var _ = require('../../server/public/libs/underscore.js');
